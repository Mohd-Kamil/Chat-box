...
**Your Response:** (Respond naturally as ShawnGPT, being immersive and engaging. If there are API results above, use them to answer the user's question in a helpful, conversational way. If not, just chat as usual.)`;
