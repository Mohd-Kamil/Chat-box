      ...
      <div className="relative z-10">
            ...
            <div className="text-center mb-12 lg:mb-20">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button
                  ...
                  className="border-slate-600 text-white hover:bg-slate-800 px-8 lg:px-12 py-3 lg:py-4 text-lg lg:text-xl font-semibold"
                >
                  Try a Joke 😄
                </Button>
              </div>
        ...
        <footer className="px-4 lg:px-6 py-6 lg:py-8 border-t border-slate-800 text-center text-gray-400">
          <p className="text-xs lg:text-sm">
            Powered by Gemini AI, TMDb, RAWG & Serper APIs • Built with ❤️ for real conversations
          </p>
        </footer>
      </div>
    </div>
