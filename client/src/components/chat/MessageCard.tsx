  ...
  if (message.role === 'user') {
    return (
      <div className="flex justify-end">
        <div className="max-w-2xl bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-2xl rounded-tr-sm px-4 lg:px-6 py-3 lg:py-4 shadow-lg">
  ...
  return (
    <div className="flex justify-start">
      <div className="max-w-4xl w-full">
        <div className={cn(
          "bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-2xl rounded-tl-sm p-4 lg:p-6 shadow-lg",
          ...
          <div className="flex items-center space-x-3 mb-3 lg:mb-4">
            ...
            <span className="text-white font-medium text-sm lg:text-base">ShawnGPT</span>
          ...
          <div className="prose prose-invert max-w-none">
            <p className="text-gray-200 mb-3 lg:mb-4 leading-relaxed whitespace-pre-wrap text-sm lg:text-base">
              {message.content}
            </p>
              ...
              <div className="mb-4 lg:mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-4">
                  {movies.slice(0, 6).map((movie: any) => (
                    <div key={movie.id} className="bg-gray-800/50 rounded-lg p-3 lg:p-4 hover:bg-gray-800 transition-colors">
                      {movie.poster_path && (
                        <img 
                          src={`https://image.tmdb.org/t/p/w300${movie.poster_path}`}
                          alt={movie.title}
                          className="w-full h-32 lg:h-40 object-cover rounded-lg mb-2 lg:mb-3"
                        />
                      )}
                      <h4 className="text-white font-medium text-sm lg:text-base">{movie.title}</h4>
              ...
              <div className="mb-4 lg:mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 lg:gap-4">
                  {people.slice(0, 6).map((person: any) => (
                    <div key={person.id} className="bg-gray-800/50 rounded-lg p-3 lg:p-4 hover:bg-gray-800 transition-colors">
                      {person.profile_path && (
                        <img 
                      ...
                      <h4 className="text-white font-medium text-sm lg:text-base">{person.name}</h4>
                      <p className="text-xs lg:text-sm text-gray-400">
              ...
              <div className="mb-4 lg:mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 lg:gap-4">
                  {games.slice(0, 4).map((game: any) => (
                    <div key={game.id} className="bg-gray-800/50 rounded-lg p-3 lg:p-4 hover:bg-gray-800 transition-colors">
                      ...
                      <h4 className="text-white font-medium text-sm lg:text-base">{game.name}</h4>
                      <p className="text-xs lg:text-sm text-gray-400">
          ...
          {/* Sources */}
          {sources.length > 0 && (
            <div className="mt-4 lg:mt-6 pt-3 lg:pt-4 border-t border-gray-700">
              ...
              <div className="flex flex-wrap gap-2">
                {sources.slice(0, 3).map((source: any, index: number) => (
                  <a 
                    ...
                    className="inline-flex items-center space-x-2 text-xs bg-gray-800 hover:bg-gray-700 px-2 lg:px-3 py-1.5 lg:py-2 rounded-full transition-colors"
                  >
