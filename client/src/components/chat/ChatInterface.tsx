...
import { Menu, X, Plus, Bot, Home, ArrowLeft, Settings } from "lucide-react";
    ...
    <div className="flex h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white overflow-hidden relative">
      ...
      {isMobileSidebarOpen && (
        <div className="lg:hidden fixed inset-0 bg-black/50 backdrop-blur-sm z-50">
          <div className="w-80 h-full bg-slate-900/95 backdrop-blur-xl border-r border-slate-700">
      ...
      {isMobileInfoPanelOpen && (
        <div className="lg:hidden fixed inset-0 bg-black/50 backdrop-blur-sm z-50">
          <div className="w-full h-full bg-slate-900/95 backdrop-blur-xl">
            <div className="p-4 border-b border-slate-700 flex items-center justify-between">
              <h3 className="text-lg font-semibold text-white">Settings & Info</h3>
              <Button
                variant="ghost"
                size="icon"
      ...
      <div className="flex-1 flex flex-col min-w-0 relative z-10">
        {/* Mobile Header */}
        <div className="lg:hidden bg-slate-900/95 backdrop-blur-xl border-b border-slate-700 p-4 flex items-center justify-between">
          <Button
            variant="ghost"
            size="icon"
        ...
        <div className="lg:hidden bg-slate-800/50 backdrop-blur-sm border-b border-slate-700 p-3">
          <div className="flex gap-2 overflow-x-auto pb-2">
            {[
              ...
              <button
                key={mode.key}
                className={cn(
                  "px-4 py-2 rounded-lg text-sm font-medium flex items-center space-x-2 whitespace-nowrap transition-colors",
          ...
          <div className="max-w-4xl mx-auto px-4 py-6 lg:py-8">
            {messages.length === 0 ? (
              <div className="text-center mb-8 lg:mb-12">
                ...
                <h2 className="text-2xl lg:text-3xl font-bold text-white mb-2">Ready to Chat!</h2>
                <p className="text-gray-400 text-base lg:text-lg mb-4">What's on your mind, yaar? Let's talk!</p>
