...
export default function InfoPanel() {
  ...
  return (
    <div className="w-full bg-card-dark border-l border-border-gray flex flex-col h-full">
      ...
      {/* Feature Cards - Make this scrollable */}
      <div className="flex-1 overflow-y-auto p-6 space-y-4">
        ...
        <div className="bg-gradient-to-r from-blue-600/20 to-purple-600/20 border border-blue-600/30 rounded-lg p-4">
          ...
          <p className="text-sm text-gray-300 mb-3">
            I automatically switch between modes based on your message:
          </p>
          <div className="space-y-2 text-xs">
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-orange-400 rounded-full"></div>
              <span className="text-gray-300">🔍 <strong>Research:</strong> "search", "find", "what is"</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
              <span className="text-gray-300">🎬 <strong>Cinephile:</strong> "movie", "actor", "film"</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-emerald-400 rounded-full"></div>
              <span className="text-gray-300">🎮 <strong>Game:</strong> "game", "gaming", "play"</span>
            </div>
            <div className="flex items-center space-x-2">
              <div className="w-2 h-2 bg-blue-400 rounded-full"></div>
              <span className="text-gray-300">💬 <strong>Chat:</strong> casual conversation</span>
            </div>
          </div>
        </div>
